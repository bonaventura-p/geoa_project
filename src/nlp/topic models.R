...
setwd("~/post_transfer")
corpus <- readRDS("UKCorpus_PeakLow.rds") # note the relative path. This should now work for everyone.
...
##########ATTENTION I AM DOING THIS ONLY FOR THE COMMONWEALTH

corpus$text_preprocessed_all=corpus$text_preprocessed
corpus$text_preprocessed=corpus$text_preprocessed[entity_id= c(6)]
...
write.csv(corpus$text_preprocessed, "corpus_w2v.csv", row.names = F, fileEncoding = "utf-8")
...
CANNOT ALLOCATE A VECTOR OF 1MB
