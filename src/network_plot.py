import pandas as pd
import numpy as np
from filemanager import GSheetClient, GraphInputMaker, GraphMaker, NodeColorMaker, NodeSizeMaker, NetworkPlotMaker
import sys
import os

ind=sys.argv[1] #replied_to, mentioned
...
for action in mention_df.action.unique().tolist():
    ...
    #we invert because distance is cost so higher replies lower cost
